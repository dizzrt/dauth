...
const file_user_user_proto_rawDesc = "" +
	...
	"\n" +
	"deleted_at\x18\b \x01(\x04R\tdeletedAt\"a\n" +
	...
	"\x14EMAIL_ALREADY_EXISTS\x10\xec\a\x1a\x05\xd0\xf3\x18\xec\a2\xb8\x01\n" +
	"\vUserService\x12Q\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	":\x01*\"\x05/user\x12V\n" +
	"\vGetUserByID\x12\x18.user.GetUserByIDRequest\x1a\x19.user.GetUserByIDResponse\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/user/{id}B+Z)github.com/dizzrt/dauth/api/gen/user;userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	1, // 0: user.GetUserByIDResponse.user:type_name -> user.User
	...
	5, // 4: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
